...
| popup             | [`Popup`](https://stdf.dev/components?nav=popup&tab=1) \| `null` | `{}`                                       | N        | Popup parameters, pass null to disable popup.                                  |
| button            | [`Button`](https://stdf.dev/components?nav=button&tab=1)         | `{}`                                       | N        | Confirm button parameters.                                                     |
| card              | [`Card`](https://stdf.dev/components?nav=card&tab=1)             | `{}`                                       | N        | Month card parameters, effective when monthCard is true.                       |
