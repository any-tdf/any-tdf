...
| -------- | ------------------- | --------------------- | ------------------------------------------ |
| change   | `{ value: number }` | value - current value | Triggered when the value changes.          |
| decrease | `() => void`        | -                     | Triggered when decrease button is clicked. |
| increase | `() => void`        | -                     | Triggered when increase button is clicked. |
