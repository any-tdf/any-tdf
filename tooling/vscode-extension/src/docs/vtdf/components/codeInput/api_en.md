...
| -------------- | ---------------------------- | --------------------------------------------- |
| change         | `(value: string) => void`    | Triggered when input value changes            |
| finish         | `(value: string) => void`    | Triggered when input is complete              |
| close          | `() => void`                 | Triggered when keyboard closes (if autoClose) |
| focus          | `() => void`                 | Triggered when focused                        |
| focused-change | `(focused: boolean) => void` | Triggered when focused state changes          |
