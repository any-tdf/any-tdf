...
| ------ | ------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------- |
| change | `(value: number, valueRange?: [number, number], label?: string \| number, labelRange?: [string \| number, string \| number]) => void` | value - Current value; valueRange - Value array for range selection; label - Current label (if stepLabels provided); labelRange - Label array for range selection. | Triggered when value changes. |

## Slider Children

| Name     | Type     | Parameters | Description                                  |
| -------- | -------- | ---------- | -------------------------------------------- |
| children | Vue Slot | -          | Content to be rendered in the progress area. |
