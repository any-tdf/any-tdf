...
The CLI requires Node.js 20.19 or newer, or Node.js 22.12 or newer. Generated projects may use Bun, npm, pnpm, or Yarn, while this repository uses Bun for development and verification.
...
- [RTDF](https://rtdf.dev)
- [VTDF](https://vtdf.dev)
- [Source](https://github.com/any-tdf/any-tdf/tree/main/tooling/create-any-tdf)
