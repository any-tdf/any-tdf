...
| Name        | Type     | Params | Description        |
| ----------- | -------- | ------ | ------------------ |
| leftChild   | Vue Slot | -      | Leftmost content.  |
| rightChild  | Vue Slot | -      | Rightmost content. |
| detailChild | Vue Slot | -      | Detail content.    |
...
| Name     | Type     | Params | Description                                      |
| -------- | -------- | ------ | ------------------------------------------------ |
| children | Vue Slot | -      | Cell Group content, usually multiple Cell items. |
