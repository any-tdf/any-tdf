...
Set transition animation via `transitionType` property. VTDF provides built-in transition functions for regular DOM elements:
...
Use `children` Vue Slot to fully customize alert content for more complex interactions.
