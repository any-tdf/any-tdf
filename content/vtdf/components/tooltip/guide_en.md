...
In addition to passing text content via the `content` property, you can use the `#content` slot to customize more complex content, such as tips with icons or multi-line content. `contentRender` and `contentSnippet` are kept as compatibility aliases.
