...
| ------ | -------------------------------------------------- | -------------------------------------- | --------------------------------------- |
| change | `(index: number \| number[] \| undefined) => void` | Current active index (single/multiple) | Triggered when expand/collapse changes. |

## Accordion Children

| Name     | Type                                                  | Params                      | Description          |
| -------- | ----------------------------------------------------- | --------------------------- | -------------------- |
| children | `Vue Slot<[item: AccordionItemProps, index: number]>` | Current item data and index | Custom content area. |
