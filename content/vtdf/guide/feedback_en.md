...
VTDF provides functional API for 5 feedback components, allowing you to use them anywhere (including non-Vue component code) through function calls.
...
<template>
	...
	<Toast v-model:visible="visible" @close="visible = false">
