...
RTDF 使用 [@any-tdf/vite-plugin-svg-symbol](https://www.npmjs.com/package/@any-tdf/vite-plugin-svg-symbol) 将项目中的 SVG 文件合并成 SVG Sprites。由于 SVG 格式的多样性，可能存在处理不准确的情况，请到 [GitHub](https://github.com/any-tdf/any-tdf/issues) 提 Issue，注明 SVG 文件的具体情况。
