...
| 名称              | 类型                                                                 | 默认值                                                  | 必传 | 说明                                                         |
| ----------------- | -------------------------------------------------------------------- | ------------------------------------------------------- | ---- | ------------------------------------------------------------ |
| refreshing        | `boolean`                                                            | `false`                                                 | N    | 是否正在刷新，支持受控绑定。                                 |
...
| loadingIcon       | [`Loading`](https://stdf.dev/components?nav=loading&tab=1) \| `null` | `{ type: '1_0', width: '4', height: '4', theme: true }` | N    | 刷新中 Loading 图标配置，传 `null` 时不展示图标。            |
...
| normalChild     | `Snippet<[detail]>` | `detail` | 初始状态内容。   |
| pullingChild    | `Snippet<[detail]>` | `detail` | 下拉中状态内容。 |
| canReleaseChild | `Snippet<[detail]>` | `detail` | 可释放状态内容。 |
| refreshingChild | `Snippet<[detail]>` | `detail` | 刷新中状态内容。 |
| successChild    | `Snippet<[detail]>` | `detail` | 成功状态内容。   |
