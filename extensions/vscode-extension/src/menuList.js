	...
	},
	{
		...
		childs: [
			...
			},
			{
				...
				title_zh: '下拉刷新',
				title_en: 'PullRefresh',
				nav: 'pullRefresh',
				tip: '在用户明确下拉时，重新同步页面数据。',
				tip_en: 'Refresh page data when users explicitly pull down.',
				alias: 'pullRefresh | 下拉刷新 | refresh | pull | reload'
			},
			{
				title: '上滑加载 InfiniteScroll',
				title_zh: '上滑加载',
				title_en: 'InfiniteScroll',
				nav: 'infiniteScroll',
				tip: '滚动接近边界时，继续加载更多内容。',
				tip_en: 'Load more content when scrolling near the edge.',
				alias: 'infiniteScroll | 上滑加载 | 无限滚动 | load more | infinite | scroll'
			}
		]
	},
	{
