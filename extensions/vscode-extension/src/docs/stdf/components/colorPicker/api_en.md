...
| popup        | [`Popup`](https://stdf.dev/components?nav=popup&tab=1)\|`null` | `{}`                      | N        | Popup params, `null` for inline.     |
| tab          | [`Tab`](https://stdf.dev/components?nav=tabs&tab=1)            | `{}`                      | N        | Tab config params.                   |
