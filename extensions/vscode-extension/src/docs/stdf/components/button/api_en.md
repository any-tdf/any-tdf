...
| icon            | [`Icon`](https://stdf.dev/components?nav=icon&tab=1)\|`null`                  | `null`    | N        | Icon props.                                                                                     |
| iconPosition    | `'left'\|'right'`                                                             | `'left'`  | N        | Icon position.                                                                                  |
| loading         | [`Loading`](https://stdf.dev/components?nav=loading&tab=1)\|`null`            | `null`    | N        | Loading props.                                                                                  |
