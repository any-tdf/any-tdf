...
| injClass        | `string`                                 | `''`        | Injected CSS class name                                                            |
| others          | -                                        | -           | Supports other Dialog component Props (except visible, contentChild, primaryChild) |
...
| injClass   | `string`                                 | `''`       | Injected CSS class name                                             |
| others     | -                                        | -          | Supports other Modal component Props (except visible, contentChild) |
...
| -------------------------- | ------------------------------------------------------------------------------- |
| **Vue Slot**               | Cannot pass `children`, `contentChild`, `primaryChild` and other custom content |
