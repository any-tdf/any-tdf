...
| 名称   | 类型                      | 参数                        | 描述                                             |
| ------ | ------------------------- | --------------------------- | ------------------------------------------------ |
| change | `(value: string) => void` | value - 选中的 Radio 标识符 | 点击 RadioItem（即 Radio 的 value 变化）时触发。 |

## Radio Children

| 名称       | 类型                                              | 参数            | 说明                     |
| ---------- | ------------------------------------------------- | --------------- | ------------------------ |
| radioChild | `(payload: { item: RadioItemProps }) => Vue Slot` | item - 选项数据 | 当选项区域自定义时使用。 |
...
| 名称  | 类型                     | 参数                | 说明         |
| ----- | ------------------------ | ------------------- | ------------ |
| click | `(name: string) => void` | name - 点击项标识符 | 点击时触发。 |

## RadioItem Children

| 名称     | 类型     | 参数 | 说明           |
| -------- | -------- | ---- | -------------- |
| children | Vue Slot | -    | 选项区域内容。 |
