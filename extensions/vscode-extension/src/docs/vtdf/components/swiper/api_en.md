...
| ------ | --------------------------- | ----------------------- | ---------------------------------------- |
| click  | `(current: number) => void` | current - clicked index | Triggered when clicking container image. |
| change | `(current: number) => void` | current - current index | Triggered when active container changes. |
