...
| prev    | `() => void`                               | -                                                                             | Triggered when clicking previous level. |
| next    | `(index: number) => void`                  | index - Index of selected item in current column                              | Triggered when clicking next level.     |
| confirm | `(items: any[], indexs: number[]) => void` | items - Array of selected column data<br />indexs - Array of selected indexes | Triggered when clicking confirm.        |
