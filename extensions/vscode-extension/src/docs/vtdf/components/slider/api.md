...
| 名称   | 类型                                                                                                                                  | 参数                                                                                                                        | 描述             |
| ------ | ------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------- | ---------------- |
| change | `(value: number, valueRange?: [number, number], label?: string \| number, labelRange?: [string \| number, string \| number]) => void` | value - 当前值；valueRange - 区间选择时的取值数组；label - 当前标签（如有 stepLabels）；labelRange - 区间选择时的标签数组。 | 取值变化时触发。 |

## Slider Children

| 名称     | 类型     | 参数 | 说明                     |
| -------- | -------- | ---- | ------------------------ |
| children | Vue Slot | -    | 传入将渲染进度区域内容。 |
