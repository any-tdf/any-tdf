...
| submitChildren | `Vue Slot`                                                | -      | N    | 自定义提交按钮内容。                                   |
| resetChildren  | `Vue Slot`                                                | -      | N    | 自定义重置按钮内容。                                   |
...
| 名称   | 类型                                             | 参数                      | 说明                 |
| ------ | ------------------------------------------------ | ------------------------- | -------------------- |
| change | `(data: Record<string, FormValueProps>) => void` | data - 所有表单项的当前值 | 表单项值变化时触发。 |
| submit | `(data: Record<string, FormValueProps>) => void` | data - 所有表单项的当前值 | 提交时触发。         |
| reset  | `() => void`                                     | -                         | 重置时触发。         |
...
| 名称           | 类型     | 参数 | 说明                 |
| -------------- | -------- | ---- | -------------------- |
| submitChildren | Vue Slot | -    | 自定义提交按钮内容。 |
| resetChildren  | Vue Slot | -    | 自定义重置按钮内容。 |
