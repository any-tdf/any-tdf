...
| 名称           | 类型                         | 参数              | 说明                                     |
| -------------- | ---------------------------- | ----------------- | ---------------------------------------- |
| change         | `(value: string) => void`    | value: 当前输入值 | 输入值变化时触发。                       |
| finish         | `(value: string) => void`    | value: 当前输入值 | 输入完成时触发。                         |
| close          | `() => void`                 | -                 | 键盘关闭时触发（autoClose 为 true 时）。 |
| focus          | `() => void`                 | -                 | 聚焦时触发。                             |
| focused-change | `(focused: boolean) => void` | focused: 是否聚焦 | 聚焦状态变化时触发。                     |
