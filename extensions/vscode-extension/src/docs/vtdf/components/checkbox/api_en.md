...
| ------ | ------------------------------ | ----------------------------------------- | ------------------------------ |
| change | `(checkeds: string[]) => void` | checkeds - Array of selected identifiers. | Triggered when option clicked. |

## Checkbox Children

| Name          | Type                                                 | Parameters          | Description                        |
| ------------- | ---------------------------------------------------- | ------------------- | ---------------------------------- |
| checkboxChild | `(payload: { item: CheckboxItemProps }) => Vue Slot` | item - Option data. | Used when customizing option area. |
...
| Name  | Type                     | Parameters         | Description                    |
| ----- | ------------------------ | ------------------ | ------------------------------ |
| click | `(name: string) => void` | name - Identifier. | Triggered when option clicked. |

## CheckboxItem Children

| Name     | Type     | Parameters | Description                  |
| -------- | -------- | ---------- | ---------------------------- |
| children | Vue Slot | -          | Content of option text area. |
