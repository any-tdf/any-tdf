...
| ------ | --------------------------- | ----------------------------- | -------------------------------------- |
| change | `(current: number) => void` | current - Current page number | Triggered when page number changes.    |
| next   | `(current: number) => void` | current - Current page number | Triggered when clicking next page.     |
| pre    | `(current: number) => void` | current - Current page number | Triggered when clicking previous page. |
