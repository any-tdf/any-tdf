...
| easeType           | `EasingProps`                                                                      | `'cubicOut'` | N    | 出现动画，共 31 个值，VTDF 内置 easing 函数集。 |
| easeOutType        | `EasingProps`                                                                      | `'cubicOut'` | N    | 退出动画，共 31 个值，VTDF 内置 easing 函数集。 |
...
| 名称       | 类型         | 参数 | 描述                                                        |
| ---------- | ------------ | ---- | ----------------------------------------------------------- |
| click-mask | `() => void` | -    | 点击弹出层遮罩时触发，即使 maskClosable 为 false 也会触发。 |
| close      | `() => void` | -    | 弹出层关闭时触发。                                          |
