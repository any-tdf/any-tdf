...
| easing       | EasingProps                                                         | `'cubicOut'` | N        | Easing function, 31 values available, VTDF includes built-in easing functions. |
...
| -------- | ------------------------- | -------------------- | ----------------------------------- |
| start    | `() => void`              | -                    | Triggered when animation starts.    |
| complete | `() => void`              | -                    | Triggered when animation completes. |
| change   | `(value: string) => void` | value: current value | Triggered when value changes.       |

## CharRoll Children

| Name     | Type     | Parameters                  | Description              |
| -------- | -------- | --------------------------- | ------------------------ |
| children | Vue Slot | char: string, index: number | Custom character render. |
