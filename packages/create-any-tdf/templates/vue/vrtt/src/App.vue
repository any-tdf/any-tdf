		...
		<main class="mx-auto min-h-screen max-w-md bg-bg-base text-text-primary dark:bg-bg-base-dark dark:text-text-dark">
			<div class="flex items-center justify-center gap-3 pt-10 text-center">
				...
				<a class="flex w-10 flex-col items-center" href="https://tailwindcss.com" target="_blank" rel="noreferrer">
					<div class="flex h-10 w-10 items-center justify-center rounded-full bg-blue text-sm font-bold text-white">T</div>
				</a>
			...
			<div class="my-6 text-center text-xs">
				<template v-if="isZh">
					<p>这是 Vite、Vue、Tailwind CSS、TypeScript 与 VTDF 构建的模板。</p>
					<p class="mt-2">点击上方 LOGO 了解更多。</p>
				</template>
				<template v-else>
					<p>This is a template using Vite, Vue, Tailwind CSS, TypeScript, and VTDF.</p>
