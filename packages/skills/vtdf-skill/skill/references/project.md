...
- VTDF targets Vue 3.
- VTDF expects Tailwind CSS 4.
- Use `bun` commands by default.
- Package import: `vtdf`.
- Theme runtime helpers import: `vtdf/theme`.
- Tailwind CSS theme plugin path: `vtdf/theme/plugin`.
...
In the application entry CSS, import Tailwind, configure dark mode, declare theme variables, and point Tailwind source detection at VTDF component classes:
...
- Use `@source "../node_modules/vtdf/dist";` so Tailwind CSS 4 can detect VTDF package classes.
