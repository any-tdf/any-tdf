...
<!-- source-docs: content/vtdf/components/fullKeyboard/guide_en.md, content/vtdf/components/fullKeyboard/api_en.md, content/vtdf/components/fullKeyboard/FAQ_en.md, content/vtdf/components/fullKeyboard/version_en.md -->
...
| popup        | [`Popup`](./popup.md)\|`null`                             | `{}`                           | N        | Popup parameters. Pass `null` to display directly. |
