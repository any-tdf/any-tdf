...
<!-- source-docs: content/vtdf/components/stepper/guide_en.md, content/vtdf/components/stepper/api_en.md, content/vtdf/components/stepper/FAQ_en.md, content/vtdf/components/stepper/version_en.md -->
...
| loading         | [`Loading`](./loading.md)                             | `{}`    | N        | Loading parameters in async state.                 |
