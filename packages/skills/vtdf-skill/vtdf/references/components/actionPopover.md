...
<!-- source-docs: content/vtdf/components/actionPopover/guide_en.md, content/vtdf/components/actionPopover/api_en.md, content/vtdf/components/actionPopover/FAQ_en.md, content/vtdf/components/actionPopover/version_en.md -->
...
| icon      | [`Icon`](./icon.md)                                        | `null`     | N        | Option icon, takes priority over image.                                                              |
...
| Name     | Type                                                       | Default    | Required | Description                    |
| -------- | ---------------------------------------------------------- | ---------- | -------- | ------------------------------ |
| icon     | [`Icon`](./icon.md)                                        | -          | Y        | Action item icon.              |
