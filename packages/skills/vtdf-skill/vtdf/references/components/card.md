...
<!-- source-docs: content/vtdf/components/card/guide_en.md, content/vtdf/components/card/api_en.md, content/vtdf/components/card/FAQ_en.md, content/vtdf/components/card/version_en.md -->
