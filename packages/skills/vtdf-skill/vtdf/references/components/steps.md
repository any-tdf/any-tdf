...
<!-- source-docs: content/vtdf/components/steps/guide_en.md, content/vtdf/components/steps/api_en.md, content/vtdf/components/steps/FAQ_en.md, content/vtdf/components/steps/version_en.md -->
...
| content | [`Icon`](./icon.md) | `-`     | Y        | Icon parameters.                        |
