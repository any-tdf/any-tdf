...
<!-- source-docs: content/vtdf/components/rate/guide_en.md, content/vtdf/components/rate/api_en.md, content/vtdf/components/rate/FAQ_en.md, content/vtdf/components/rate/version_en.md -->
