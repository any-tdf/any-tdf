...
<!-- source-docs: content/vtdf/components/alert/guide_en.md, content/vtdf/components/alert/api_en.md, content/vtdf/components/alert/FAQ_en.md, content/vtdf/components/alert/version_en.md -->
...
| icon             | [`Icon`](./icon.md)                             | `{}`         | N        | Custom icon configuration.                                              |
...
| card             | [`Card`](./card.md)                             | `{}`         | N        | Card component configuration.                                           |
