...
<!-- source-docs: content/vtdf/components/calendar/guide_en.md, content/vtdf/components/calendar/api_en.md, content/vtdf/components/calendar/FAQ_en.md, content/vtdf/components/calendar/version_en.md -->
...
| popup             | [`Popup`](./popup.md) \| `null`                           | `{}`                                       | N        | Popup parameters, pass null to disable popup.                                  |
| button            | [`Button`](./button.md)                                   | `{}`                                       | N        | Confirm button parameters.                                                     |
| card              | [`Card`](./card.md)                                       | `{}`                                       | N        | Month card parameters, effective when monthCard is true.                       |
