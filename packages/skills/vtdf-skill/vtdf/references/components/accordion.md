...
<!-- source-docs: content/vtdf/components/accordion/guide_en.md, content/vtdf/components/accordion/api_en.md, content/vtdf/components/accordion/FAQ_en.md, content/vtdf/components/accordion/version_en.md -->
...
| icon     | [`Icon`](./icon.md) | `undefined` | N        | Title left icon.  |
