...
<!-- source-docs: content/vtdf/components/picker/guide_en.md, content/vtdf/components/picker/api_en.md, content/vtdf/components/picker/FAQ_en.md, content/vtdf/components/picker/version_en.md -->
...
| multipleIcon       | [`Icon`](./icon.md)                | `{ name: 'ri-checkbox-circle-line', ... }` | N        | Icon for unselected state in multiple mode.                |
| multipleIconActive | [`Icon`](./icon.md)                | `{ name: 'ri-checkbox-circle-fill', ... }` | N        | Icon for selected state in multiple mode.                  |
