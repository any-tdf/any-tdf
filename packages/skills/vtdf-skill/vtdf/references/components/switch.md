...
<!-- source-docs: content/vtdf/components/switch/guide_en.md, content/vtdf/components/switch/api_en.md, content/vtdf/components/switch/FAQ_en.md, content/vtdf/components/switch/version_en.md -->
...
| loading  | [`Loading`](./loading.md)                             | `{}`    | N        | Loading component parameters, only effective when inside is `'loading'`. |
