...
<!-- source-docs: content/vtdf/components/imageList/guide_en.md, content/vtdf/components/imageList/api_en.md, content/vtdf/components/imageList/FAQ_en.md, content/vtdf/components/imageList/version_en.md -->
...
| loading      | [`Loading`](./loading.md)                                 | `{}`        | N        | Loading component parameters.         |
| icon         | [`Icon`](./icon.md)                                       | `{}`        | N        | Upload icon parameters.               |
| deleteIcon   | [`Icon`](./icon.md)                                       | `{}`        | N        | Delete icon parameters.               |
