...
<!-- source-docs: content/vtdf/components/button/guide_en.md, content/vtdf/components/button/api_en.md, content/vtdf/components/button/FAQ_en.md, content/vtdf/components/button/version_en.md -->
...
The button group feature has been extracted to the [ButtonGroup](./buttonGroup.md) component, which supports two ways of use: `items` array or `children` customization.
...
| icon            | [`Icon`](./icon.md)\|`null`                                                   | `null`    | N        | Icon props.                                                                                     |
| iconPosition    | `'left'\|'right'`                                                             | `'left'`  | N        | Icon position.                                                                                  |
| loading         | [`Loading`](./loading.md)\|`null`                                             | `null`    | N        | Loading props.                                                                                  |
