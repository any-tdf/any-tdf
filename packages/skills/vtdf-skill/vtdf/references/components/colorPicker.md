...
<!-- source-docs: content/vtdf/components/colorPicker/guide_en.md, content/vtdf/components/colorPicker/api_en.md, content/vtdf/components/colorPicker/FAQ_en.md, content/vtdf/components/colorPicker/version_en.md -->
...
| popup        | [`Popup`](./popup.md)\|`null`                             | `{}`                      | N        | Popup params, `null` for inline.     |
| tab          | [`Tab`](./tabs.md)                                        | `{}`                      | N        | Tab config params.                   |
