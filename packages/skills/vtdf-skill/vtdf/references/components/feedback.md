...
<!-- source-docs: content/vtdf/components/feedback/guide_en.md, content/vtdf/components/feedback/api_en.md, content/vtdf/components/feedback/FAQ_en.md, content/vtdf/components/feedback/version_en.md -->
...
| mask           | [`Mask`](./mask.md)                                      | `{}`       | Mask options                                                    |
| loading        | [`Loading`](./loading.md)                                | `{}`       | Loading icon options                                            |
| icon           | [`Icon`](./icon.md)                                      | `{}`       | Icon options                                                    |
...
| icon           | [`Icon`](./icon.md)                             | `{}`    | Custom icon options                                             |
| closable       | `boolean`                                       | `true`  | Whether to show the close button                                |
| inverse        | `boolean`                                       | `true`  | Whether to use inverse style                                    |
| card           | [`Card`](./card.md)                             | `{}`    | Outer card options                                              |
...
| popup           | [`Popup`](./popup.md)                 | `{}`        | Popup options                                                                      |
| showIcon        | `boolean`                             | `false`     | Whether to show the icon                                                           |
| icon            | [`Icon`](./icon.md)                   | `{}`        | Icon options                                                                       |
| btnStyle        | `'button'\|'text'\|'textLine'`        | `'button'`  | Button style                                                                       |
| primaryButton   | [`Button`](./button.md)               | `{}`        | Primary button options                                                             |
| secondaryButton | [`Button`](./button.md)               | `{}`        | Secondary button options                                                           |
...
| button     | [`Button`](./button.md)     | `{}`       | Button options                                                      |
| injClass   | `string`                    | `''`       | Injected CSS class name                                             |
...
For full functionality, please use the corresponding components directly: [Toast](./toast.md), [Dialog](./dialog.md), [Modal](./modal.md), [Alert](./alert.md), [Loading](./loading.md).
