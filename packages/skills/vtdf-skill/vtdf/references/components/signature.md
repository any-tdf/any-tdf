...
<!-- source-docs: content/vtdf/components/signature/guide_en.md, content/vtdf/components/signature/api_en.md, content/vtdf/components/signature/FAQ_en.md, content/vtdf/components/signature/version_en.md -->
...
| clearButton       | [`Button`](./button.md)                                   | `{}`        | N        | Clear button parameters                                      |
| confirmButton     | [`Button`](./button.md)                                   | `{}`        | N        | Confirm button parameters                                    |
