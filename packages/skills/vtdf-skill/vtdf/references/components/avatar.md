...
<!-- source-docs: content/vtdf/components/avatar/guide_en.md, content/vtdf/components/avatar/api_en.md, content/vtdf/components/avatar/FAQ_en.md, content/vtdf/components/avatar/version_en.md -->
...
| icon     | [`Icon`](./icon.md)                                       | `{}`     | N        | Alternative icon.                  |
