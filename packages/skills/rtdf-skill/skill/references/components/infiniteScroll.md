...
| onload | `(isRetry: boolean) => void` | `isRetry` - whether this is an error retry | Called when the trigger distance is reached. Lowercase event alias compatible with STDF migration. |
