...
<!-- source-docs: content/rtdf/components/rate/guide_en.md, content/rtdf/components/rate/api_en.md, content/rtdf/components/rate/FAQ_en.md, content/rtdf/components/rate/version_en.md -->
