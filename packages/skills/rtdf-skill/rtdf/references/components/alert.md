...
<!-- source-docs: content/rtdf/components/alert/guide_en.md, content/rtdf/components/alert/api_en.md, content/rtdf/components/alert/FAQ_en.md, content/rtdf/components/alert/version_en.md -->
