...
<!-- source-docs: content/rtdf/components/icon/guide_en.md, content/rtdf/components/icon/api_en.md, content/rtdf/components/icon/FAQ_en.md, content/rtdf/components/icon/version_en.md -->
