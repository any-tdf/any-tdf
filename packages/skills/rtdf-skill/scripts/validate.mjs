...
if (existsSync(agentPath)) {
	...
	if (!agent.includes('interface:') || !agent.includes('default_prompt:') || !agent.includes('$rtdf')) {
		failures.push('skill/agents/openai.yaml must define interface.default_prompt mentioning $rtdf');
	}
}
