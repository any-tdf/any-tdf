...
<!-- source-docs: content/stdf/components/picker/guide_en.md, content/stdf/components/picker/api_en.md, content/stdf/components/picker/FAQ_en.md, content/stdf/components/picker/version_en.md -->
...
- [!tag|A|0|]`popup` property supports `null` to display picker without popup.
