...
<!-- source-docs: content/stdf/components/icon/guide_en.md, content/stdf/components/icon/api_en.md, content/stdf/components/icon/FAQ_en.md, content/stdf/components/icon/version_en.md -->
