...
<!-- source-docs: content/stdf/components/form/guide_en.md, content/stdf/components/form/api_en.md, content/stdf/components/form/FAQ_en.md, content/stdf/components/form/version_en.md -->
...
| card           | [`CardProps`](./card.md)                         | -       | N        | Card configuration, uses Card component to wrap form when provided. |
