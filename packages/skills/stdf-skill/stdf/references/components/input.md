...
<!-- source-docs: content/stdf/components/input/guide_en.md, content/stdf/components/input/api_en.md, content/stdf/components/input/FAQ_en.md, content/stdf/components/input/version_en.md -->
