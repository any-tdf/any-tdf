...
Use this reference when creating or modifying STDF scaffold behavior.
...
| Preset   | Meaning                                                 |
| -------- | ------------------------------------------------------- |
| `single` | Initial STDF theme only, with custom themes added later |
| `multi`  | Built-in STDF, Sage, and GoldWood themes                |
...
- Templates: `create/templates/svelte`.
- Icon snippets: `create/snippet/svelte`.
