...
const ml_IN: LangProps = {
	...
	calendar: {
		...
		monthTextList: ['ജനുവരി', 'ഫെബ്രുവരി', 'മാർച്ച്', 'ഏപ്രിൽ', 'മേയ്', 'ജൂൺ', 'ജൂലൈ', 'ഓഗസ്റ്റ്', 'സെപ്റ്റംബർ', 'ഒക്ടോബർ', 'നവംബർ', 'ഡിസംബർ'],
	...
	imagePreview: {
		loadFailedText: 'ലോഡ് പരാജയപ്പെട്ടു'
	},
	imageList: {
		uploadFailedText: 'അപ്‌ലോഡ് പരാജയപ്പെട്ടു',
		pendingText: 'തീർപ്പാക്കാത്തത്'
	}
};
