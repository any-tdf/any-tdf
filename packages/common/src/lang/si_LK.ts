...
const si_LK: LangProps = {
	...
	calendar: {
		...
		monthTextList: ['ජනවාරි', 'පෙබරවාරිය', 'මාර්තු', 'අප්‍රේල්', 'මැයි', 'ජූනි', 'ජූලි', 'අගෝස්තු', 'සැප්තැම්බර්', 'ඔක්තෝබර්', 'නොවැම්බර්', 'දෙසැම්බර්'],
	...
	signature: {
		clearText: 'හිස් කරන්න',
		confirmText: 'තහවුරු කරන්න'
	},
	imagePreview: {
		loadFailedText: 'පූරණය අසාර්ථක විය'
	},
	imageList: {
		uploadFailedText: 'උඩුගත කිරීම අසාර්ථක විය',
		pendingText: 'පොරොත්තු'
	}
};
