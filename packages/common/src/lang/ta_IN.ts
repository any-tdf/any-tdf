...
const ta_IN: LangProps = {
	...
	calendar: {
		...
		monthTextList: ['ஜனவரி', 'பிப்ரவரி', 'மார்ச்', 'ஏப்ரல்', 'மே', 'ஜூன்', 'ஜூலை', 'ஆகஸ்ட்', 'செப்டம்பர்', 'அக்டோபர்', 'நவம்பர்', 'டிசம்பர்'],
	...
	imagePreview: {
		loadFailedText: 'ஏற்றுதல் தோல்வியடைந்தது'
	},
	imageList: {
		uploadFailedText: 'பதிவேற்றம் தோல்வியடைந்தது',
		pendingText: 'நிலுவையில்'
	}
};
