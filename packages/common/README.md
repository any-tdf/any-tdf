...
[![Release Status](https://github.com/any-tdf/any-tdf/actions/workflows/release.yml/badge.svg)](https://github.com/any-tdf/any-tdf/actions/workflows/release.yml)
...
Run the manual GitHub Actions workflow after `bun run release:check` succeeds. Alpha versions are published with:
