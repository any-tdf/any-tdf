	...
	<svg xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 614 383.76" class="w-full">
		<defs>
			<linearGradient id="linear-gradient" x1="307" y1="369.32" x2="307" y2="23.88" gradientUnits="userSpaceOnUse">
				<stop offset="0" :stop-color="dark ? 'var(--color-dark-400)' : 'var(--color-primary-50)'" />
				<stop offset="1" :stop-color="dark ? 'var(--color-dark-800)' : 'var(--color-primary-500)'" />
			</linearGradient>
			...
			<linearGradient id="linear-gradient-5" x1="304.08" y1="357.53" x2="589.55" y2="357.53" gradientUnits="userSpaceOnUse">
				<stop offset="0" :stop-color="dark ? 'var(--color-dark-900)' : 'var(--color-primary-900)'" stop-opacity="0.1" />
				<stop offset="1" :stop-color="dark ? 'var(--color-dark-900)' : 'var(--color-primary-900)'" />
			</linearGradient>
			<linearGradient id="linear-gradient-6" x1="615.64" y1="385.54" x2="615.64" y2="337.77" gradientUnits="userSpaceOnUse">
				<stop offset="0" :stop-color="dark ? 'var(--color-dark-700)' : 'var(--color-primary-700)'" />
				<stop offset="1" :stop-color="dark ? 'var(--color-dark-500)' : 'var(--color-primary-500)'" />
			</linearGradient>
			...
			<linearGradient id="linear-gradient-10" x1="89.92" y1="448.19" x2="226.82" y2="254.6" gradientUnits="userSpaceOnUse">
				<stop offset="0" :stop-color="dark ? 'var(--color-dark-950)' : 'var(--color-primary-950)'" />
				<stop offset="1" :stop-color="dark ? 'var(--color-dark-800)' : 'var(--color-primary-800)'" />
			</linearGradient>
