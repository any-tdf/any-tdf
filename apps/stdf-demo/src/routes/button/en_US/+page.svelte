...
<div class="flex flex-col space-y-8 py-8">
	...
	<div>
		...
		<Button injClass="stdf-demo-button-fill">Solid color filling</Button>
		<Button injClass="stdf-demo-gradient-primary !text-white">Gradient filling</Button>
		<Button fill="line" injClass="stdf-demo-button-line">Linear</Button>
