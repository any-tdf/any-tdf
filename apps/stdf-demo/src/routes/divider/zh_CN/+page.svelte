...
<div class="flex flex-col space-y-8 py-8">
	...
	<div>
		...
		<Divider text="自定义线条" injClass="stdf-demo-border-red-purple" />
		<Divider text="自定义文字" injClass="stdf-demo-text-red" />
		<Divider text="自定义线条与文字" injClass="stdf-demo-border-text-mixed" />
		<Divider line="dashed" text="自定义虚线" injClass="stdf-demo-border-orange" />
	</div>
	<div class="px-4">
