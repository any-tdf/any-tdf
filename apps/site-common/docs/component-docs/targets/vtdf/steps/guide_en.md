...
step and finishStep support injecting Vue Slot via injVue Slot, which Steps will render at the bottom of the step area. `injComponent` is kept for legacy naming compatibility. Please refer to the examples.
