...
| popup          | [`Popup`](https://stdf.dev/components?nav=popup&tab=1) | `{}`                                    | N        | Popup layer parameters.                      |
...
| icon      | [`Icon`](https://stdf.dev/components?nav=icon&tab=1)       | `null`     | N        | Option icon, takes priority over image.                                                              |
