<script lang="ts">
	...
	// @ts-ignore
	import mdPluginText from '../../../../../../content/stdf/guide/mdPlugin.md';
	// @ts-ignore
	import mdPluginText_en from '../../../../../../content/stdf/guide/mdPlugin_en.md';
...
<svelte:head>
	<title>STDF - {isZh ? 'MD 插件' : 'MD plugin'}</title>
	<meta name="description" content={isZh ? 'STDF 移动 web 组件库 - MD 插件' : 'STDF mobile web component library - MD plugin'} />
</svelte:head>
