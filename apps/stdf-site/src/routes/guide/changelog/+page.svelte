<script lang="ts">
	...
	// @ts-ignore
	import text from '../../../../../../content/stdf/guide/changelog.md';
	// @ts-ignore
	import text_en from '../../../../../../content/stdf/guide/changelog_en.md';
...
<article class="prose dark:prose-invert prose-strong:text-primary dark:prose-strong:text-dark mx-auto max-w-full pb-8 text-xs">
