	...
	<div class="relative z-10 mx-auto">
		<div class="mb-12 text-center">
			...
			<p class="mx-auto max-w-2xl text-base opacity-70">
				{isZh ? '优雅的亮暗模式切换，为用户带来舒适的视觉体验。' : 'Elegant light/dark mode switching for comfortable visual experience.'}
			</p>
		</div>
		...
		>
			...
			<div class="relative h-full w-full overflow-hidden">
					...
					<div class="flex h-full items-center justify-center p-4 md:p-6">
						...
						<div class="flex w-full max-w-75 flex-col gap-3">
							...
							<div class="grid grid-cols-2 gap-3">
								...
								<div
									class="flex items-center justify-center rounded-xl border border-gray-200/80 bg-white/90 p-3 shadow-lg backdrop-blur-sm"
								>
				...
				<!-- 暗色层 -->
				<div class="absolute inset-0 bg-linear-to-br from-slate-900 via-gray-900 to-slate-950" style="clip-path: inset(0 0 0 {sliderPos}%)">
					<div class="flex h-full items-center justify-center p-4 md:p-6">
						<!-- 模拟卡片界面 - 暗色 - 限制宽度360 -->
