...
<section class="p-4 md:p-8">
	<div class="mx-auto max-w-6xl">
		...
		<div
			use:countUp
			class="mb-12 grid grid-cols-1 border-l border-t border-(--site-divider) sm:grid-cols-2"
		>
			{#each stats as stat, i (i)}
				<div class="border-b border-r border-(--site-divider) bg-transparent p-6 text-center">
		...
		<div class="grid grid-cols-1 border-l border-t border-(--site-divider) md:grid-cols-2">
			{#each features as feature (feature)}
				<div class="flex gap-4 border-b border-r border-(--site-divider) bg-transparent p-6">
