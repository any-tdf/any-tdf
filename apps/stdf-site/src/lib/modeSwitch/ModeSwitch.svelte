...
>
	<button
		...
		class="min-h-full cursor-pointer rounded-sm px-1 transition-all duration-150 {$themeStore === 'light'
	...
	<button
		...
		class="min-h-full cursor-pointer rounded-sm px-1 transition-all duration-150 {$themeStore === 'dark'
	...
	<button
		...
		class="min-h-full cursor-pointer rounded-sm px-1 transition-all duration-150 {$themeStore === 'auto'
