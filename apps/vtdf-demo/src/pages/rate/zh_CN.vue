...
import { ref } from 'vue';
import { Icon, Rate } from 'vtdf/components';
...
<template>
	...
	<div class="p-4">
		<Rate opacity="0.6">
			<Icon name="ri-star-fill" inj-class="vtdf-demo-text-star" />
		</Rate>
	</div>
	<div class="p-4">
		<Rate>
			<Icon name="ri-heart-3-fill" inj-class="vtdf-demo-text-red" />
		</Rate>
	</div>
	<div class="p-4">
		<Rate half>
	...
	<div class="p-4">
		<Rate half :value="value" @click="(nextValue) => (value = nextValue)" />
