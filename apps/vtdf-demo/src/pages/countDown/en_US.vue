...
<template>
	<div class="pb-4 pt-1">
		...
		<div class="flex gap-2 p-4">
			<Button size="sm" @click="() => countDownRef?.start()">Start</Button>
			<Button size="sm" fill="line" @click="() => countDownRef?.pause()">Pause</Button>
			<Button size="sm" fill="line" @click="() => countDownRef?.reset()">Reset</Button>
		</div>
	...
	<Toast v-model:visible="showToast" message="Countdown finished!" />
</template>
